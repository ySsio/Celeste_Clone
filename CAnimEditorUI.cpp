...
void CAnimEditorUI::SetBang(CAnimation* _Tex)
{
	assert(_Tex);
	m_Bang = _Tex;
	m_BangFrm = 0;
...
void CAnimEditorUI::SetBody(CAnimation* _Tex)
{
	assert(_Tex);
	m_Body = _Tex;
	m_BodyFrm = 0;
...
void CAnimEditorUI::AddBangFrm(const tAnimFrm& _Frm)
{
	m_Bang->AddFrm(_Frm);
	++m_BangFrmCnt;
...
void CAnimEditorUI::AddBodyFrm(const tAnimFrm& _Frm)
{
	m_Body->AddFrm(_Frm);
	++m_BodyFrmCnt;
...
void CAnimEditorUI::EraseBangFrm(UINT _Frm)
{
...
void CAnimEditorUI::EraseBodyFrm(UINT _Frm)
{
...
void CAnimEditorUI::Tick_DerivedUI()
{
	if (!m_Play)
		return;
...
void CAnimEditorUI::Render_DerivedUI()
{
