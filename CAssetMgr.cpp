...
void CAssetMgr::Init()
{
	...
	//pAnimFlipX->SetFlipped(true);

	//AddAnimation(L"Player_Bang", pAnim);
	//AddAnimation(L"Player_Bang_FlipX", pAnimFlipX);

	//pAnim->Save(L"\\animation\\Player_Bang.anim");
	//pAnimFlipX->Save(L"\\animation\\Player_Bang_FlipX.anim");
	...
	//pAnim->Save(L"\\animation\\Player_Idle.anim");
	//pAnimFlipX->Save(L"\\animation\\Player_Idle_FlipX.anim");
	...
	//pAnim->Save(L"\\animation\\Player_IdleA.anim");
	//pAnimFlipX->Save(L"\\animation\\Player_IdleA_FlipX.anim");
	...
	//pAnim->Save(L"\\animation\\Player_IdleB.anim");
	//pAnimFlipX->Save(L"\\animation\\Player_IdleB_FlipX.anim");
	...
	//pAnim->Save(L"\\animation\\Player_IdleC.anim");
	//pAnimFlipX->Save(L"\\animation\\Player_IdleC_FlipX.anim");
